                            ...
                            <div className="group block overflow-hidden border border-gray-800  rounded-xl border-opacity-10">
                                <Link href={`/products/${product._id}`}>
                                    <div className="relative h-[300px] sm:h-[300px] border-b">
                                        <Image src={product.images[0].src} alt="img" height={1000} width={1000} className="absolute inset-0 h-full w-full object-contain opacity-100 hover:opacity-0" />
                                        <Image src={product.images[1].src} alt="img" height={1000} width={1000} className="absolute inset-0 h-full w-full object-contain opacity-0 hover:opacity-100" />
                                    </div>
