                        ...
                        <div className="group block overflow-hidden border rounded-xl border-opacity-10">
                            <Link href={`/products/${product._id}`}>
                                <div className="relative md:h-[300px] h-[200px]">
                                    <Image src={product.images[0].src} alt="image" height={1000} width={1000} className="absolute inset-0 h-full w-full object-contain opacity-100 group-hover:opacity-0" />
                                    <Image src={product.images[1].src} alt="image" height={1000} width={1000} className="absolute inset-0 h-full w-full object-contain opacity-0 group-hover:opacity-100" />
                                </div>
