                ...
                <div className="grid grid-cols-2 lg:grid-cols-1 lg:gap-y-4 px-2 py-2 gap-2 md:gap-2">
                    {productInfo.images.slice(1, 3).map((image, index) => (
                        <div className="lg:aspect-h-2 lg:aspect-w-3 lg:rounded-lg overflow-hidden" key={index}>
                            <img src={image.src} alt="product-image" className={productInfo.title === "Nike Air Force" ? "w-full h-full md:h-[44vh] object-cover object-center border border-secondary rounded-lg" : "w-full h-full md:h-[44vh] object-contain object-center border border-secondary rounded-lg"} />
                        </div>
                    ))}
                </div>
